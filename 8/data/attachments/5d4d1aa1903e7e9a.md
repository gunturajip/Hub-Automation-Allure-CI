...
```
Error: locator.click: Error: strict mode violation: getByRole('cell').locator('a') resolved to 90 elements:
    1) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021530↵               </a> aka getByRole('cell', { name: 'R-00021530' }).locator('a')
    2) <a type="" data-v-4d46d381="" class="relative inline-flex items-center justify-center leading-none font-semibold transition-colors border cursor-pointer min-w-max opacity-100 hover:opacity-80 active:opacity-100 disabled:opacity-50 bg-white border-gray-300 text-primary gap-x-1.5 text-xs px-2 py-1 gap-1 p-1.5 text-[10px] rounded-[4px]">…</a> aka getByRole('row', { name: 'IDR 15,000.00 5 | 0 Submitted' }).locator('a').nth(1)
    3) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021528↵               </a> aka getByRole('cell', { name: 'R-00021528' }).locator('a')
    4) <a type="" data-v-4d46d381="" class="relative inline-flex items-center justify-center leading-none font-semibold transition-colors border cursor-pointer min-w-max opacity-100 hover:opacity-80 active:opacity-100 disabled:opacity-50 bg-white border-gray-300 text-primary gap-x-1.5 text-xs px-2 py-1 gap-1 p-1.5 text-[10px] rounded-[4px]">…</a> aka getByRole('row', { name: 'IDR 30,000.00 3 | 0 Submitted' }).locator('a').nth(1)
    5) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021529↵               </a> aka getByRole('cell', { name: 'R-00021529' }).locator('a')
    6) <a type="" data-v-4d46d381="" class="relative inline-flex items-center justify-center leading-none font-semibold transition-colors border cursor-pointer min-w-max opacity-100 hover:opacity-80 active:opacity-100 disabled:opacity-50 bg-white border-gray-300 text-primary gap-x-1.5 text-xs px-2 py-1 gap-1 p-1.5 text-[10px] rounded-[4px]">…</a> aka getByRole('row', { name: 'IDR 35,000.00 2 | 0 Submitted' }).locator('a').nth(1)
    7) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021527↵               </a> aka getByRole('cell', { name: 'R-00021527' }).locator('a')
    8) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021525↵               </a> aka getByRole('cell', { name: 'R-00021525' }).locator('a')
    9) <a type="" data-v-4d46d381="" class="relative inline-flex items-center justify-center leading-none font-semibold transition-colors border cursor-pointer min-w-max opacity-100 hover:opacity-80 active:opacity-100 disabled:opacity-50 bg-white border-gray-300 text-primary gap-x-1.5 text-xs px-2 py-1 gap-1 p-1.5 text-[10px] rounded-[4px]">…</a> aka getByRole('row', { name: 'CNY 13.05 1 | 0 Submitted - R' }).locator('a').nth(1)
    10) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021524↵               </a> aka getByRole('cell', { name: 'R-00021524' }).locator('a')
    ...
...
- main:
  ...
  - table:
    - rowgroup:
      - 'row "IDR 15,000.00 5 | 0 Submitted - R-00021530 Joey Irvine Julianto 25 May 2025 Corporate Expense MDSTRC-03 Test Case #03 MDSTRC-03"':
        - cell
        - cell "IDR 15,000.00":
        ...
        - cell "-":
          - paragraph: "-"
        - cell "R-00021530"
        - cell "Joey Irvine Julianto 25 May 2025":
          - paragraph: Joey Irvine Julianto
          - paragraph: 25 May 2025
        - cell "Corporate Expense MDSTRC-03":
          - paragraph: Corporate Expense MDSTRC-03
        - 'cell "Test Case #03 MDSTRC-03"':
          - paragraph: "Test Case #03 MDSTRC-03"
        - cell
      - row "IDR 30,000.00 3 | 0 Submitted - R-00021528 Joey Irvine Julianto 25 May 2025 QA Component Check Component Check for HUB-2928":
        - cell
        - cell "IDR 30,000.00":
        ...
        - cell "Joey Irvine Julianto 25 May 2025":
          - paragraph: Joey Irvine Julianto
          - paragraph: 25 May 2025
        - cell "QA Component Check":
          - paragraph: QA Component Check
        - cell "Component Check for HUB-2928":
          - paragraph: Component Check for HUB-2928
        - cell
      - row "IDR 35,000.00 2 | 0 Submitted - R-00021529 Joey Irvine Julianto 25 May 2025 Corporate Expense -":
        - cell
        - cell "IDR 35,000.00":
          - paragraph: IDR 35,000.00
        - cell "2 | 0"
        - cell "Submitted"
        - cell "-":
          - paragraph: "-"
        ...
        - cell "-":
          - paragraph: "-"
        - cell
      - row "IDR 31,629,069.77 2 | 0 Verified - R-00021527 Septian Waluyan 23 May 2025 Corporate Expense -":
        - cell
        - cell "IDR 31,629,069.77":
          - paragraph: IDR 31,629,069.77
        - cell "2 | 0"
        - cell "Verified"
        - cell "-":
          - paragraph: "-"
        - cell "R-00021527"
        - cell "Septian Waluyan 23 May 2025":
          - paragraph: Septian Waluyan
        ...
        - cell "-":
          - paragraph: "-"
        - cell
      - row "CNY 13.05 1 | 0 Submitted - R-00021525 Chris QIN 19 May 2025 10009732.1 - Unicomp - China X-Ray Tube Market Study -":
        - cell
        - cell "CNY 13.05":
          - paragraph: CNY 13.05
        - cell "1 | 0"
        ...
        - cell "-":
          - paragraph: "-"
        - cell "R-00021525"
        - cell "Chris QIN 19 May 2025":
          - paragraph: Chris QIN
          - paragraph: 19 May 2025
        - cell "10009732.1 - Unicomp - China X-Ray Tube Market Study":
          - paragraph: 10009732.1 - Unicomp - China X-Ray Tube Market Study
        - cell "-":
          - paragraph: "-"
        - cell
      - row "IDR 20,000.00 1 | 0 Submitted - R-00021524 Ananda Fitria 19 May 2025 Corporate Expense -":
        - cell
        - cell "IDR 20,000.00":
          - paragraph: IDR 20,000.00
        - cell "1 | 0"
        - cell "Submitted"
        - cell "-":
          - paragraph: "-"
        - cell "R-00021524"
        - cell "Ananda Fitria 19 May 2025":
      ...
      - row "IDR 40,000.00 1 | 0 Submitted - R-00021523 Afif Ridha Ramadhan 18 May 2025 Corporate Expense Expense 2 Veritatis cupio capio suscipio ipsam.":
        ...
        - cell
      - row "IDR 110,000.00 2 | 0 Submitted - R-00021521 Ananda Fitria 15 May 2025 Corporate Expense -":
        - cell
        - cell "IDR 110,000.00":
          - paragraph: IDR 110,000.00
        - cell "2 | 0"
        - cell "Submitted"
        - cell "-":
          - paragraph: "-"
