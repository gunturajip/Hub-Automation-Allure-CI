...
```
Error: locator.click: Error: strict mode violation: getByRole('cell').locator('a') resolved to 93 elements:
    1) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021555↵               </a> aka getByRole('cell', { name: 'R-00021555' }).locator('a')
    2) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021553↵               </a> aka getByRole('cell', { name: 'R-00021553' }).locator('a')
    3) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021554↵               </a> aka getByRole('cell', { name: 'R-00021554' }).locator('a')
    4) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021539↵               </a> aka getByRole('cell', { name: 'R-00021539' }).locator('a')
    5) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021537↵               </a> aka getByRole('cell', { name: 'R-00021537' }).locator('a')
    6) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021538↵               </a> aka getByRole('cell', { name: 'R-00021538' }).locator('a')
    7) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021540↵               </a> aka getByRole('cell', { name: 'R-00021540' }).locator('a')
    8) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021535↵               </a> aka getByRole('cell', { name: 'R-00021535' }).locator('a')
    9) <a type="" data-v-4d46d381="" class="relative inline-flex items-center justify-center leading-none font-semibold transition-colors border cursor-pointer min-w-max opacity-100 hover:opacity-80 active:opacity-100 disabled:opacity-50 bg-white border-gray-300 text-primary gap-x-1.5 text-xs px-2 py-1 gap-1 p-1.5 text-[10px] rounded-[4px]">…</a> aka getByRole('row', { name: 'IDR 45,000.00 2 | 0 Submitted' }).locator('a').nth(1)
    10) <a data-v-4d46d381="" class="inline-block text-xs text-blue-500 border-b border-blue-300 border-dashed cursor-pointer">↵                  R-00021533↵               </a> aka getByRole('cell', { name: 'R-00021533' }).locator('a')
    ...
...
- main:
  ...
  - table:
    - rowgroup:
      - row "IDR 100,000.00 1 | 1 Approved - R-00021555 Septian Waluyan 07 Jun 2025 [FIX] Corporate Expense MDSTRC-72 MDSTRC-72":
        - cell
        - cell "IDR 100,000.00":
        ...
        - cell "-":
          - paragraph: "-"
        - cell "R-00021555"
        - cell "Septian Waluyan 07 Jun 2025":
          - paragraph: Septian Waluyan
          - paragraph: 07 Jun 2025
        - cell "[FIX] Corporate Expense MDSTRC-72":
          - paragraph: "[FIX] Corporate Expense MDSTRC-72"
        - cell "MDSTRC-72":
          - paragraph: MDSTRC-72
        - cell
      - row "IDR 150,000.00 1 | 1 Approved - R-00021553 Septian Waluyan 07 Jun 2025 Corporate Expense MDSTRC-72 MDSTRC-72":
        - cell
        - cell "IDR 150,000.00":
          - paragraph: IDR 150,000.00
        - cell "1 | 1"
        - cell "Approved"
        - cell "-":
          - paragraph: "-"
        ...
        - cell "Septian Waluyan 07 Jun 2025":
          - paragraph: Septian Waluyan
          - paragraph: 07 Jun 2025
        - cell "Corporate Expense MDSTRC-72":
          - paragraph: Corporate Expense MDSTRC-72
        - cell "MDSTRC-72":
          - paragraph: MDSTRC-72
        - cell
      - row "IDR 0.00 0 | 2 Rejected rejection test R-00021554 Dhendy Rizki Fadhillah 07 Jun 2025 MDSTRC-78 MDSTRC-78":
        - cell
        - cell "IDR 0.00":
          - paragraph: IDR 0.00
        - cell "0 | 2"
        - cell "Rejected"
        - cell "rejection test":
          - paragraph: rejection test
        - cell "R-00021554"
        - cell "Dhendy Rizki Fadhillah 07 Jun 2025":
          - paragraph: Dhendy Rizki Fadhillah
          - paragraph: 07 Jun 2025
        - cell "MDSTRC-78":
          - paragraph: MDSTRC-78
        - cell "MDSTRC-78":
          - paragraph: MDSTRC-78
        - cell
      - row "IDR 81,000.00 2 | 1 Approved - R-00021539 Joey Irvine Julianto 03 Jun 2025 Corporate Expense MDSTRC-52 MDSTRC-52 edited by applicant":
        - cell
        - cell "IDR 81,000.00":
          - paragraph: IDR 81,000.00
